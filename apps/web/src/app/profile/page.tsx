...
export default function ProfilePage() {
    ...
    async function loadReferral() {
      ...
      try {
        const res = await fetch(
          `https://your-api-service-name.up.railway.app/users/user`,
          {
  ...
  useEffect(() => {
    async function loadReferredUsers() {
      ...
      try {
        const res = await fetch(
          `https://your-api-service-name.up.railway.app/users/referrals?code=${encodeURIComponent(referralCode)}`,
          { headers: { Authorization: `Bearer ${session.access_token}` } }
        );
        if (res.ok) {
  ...
  async function handleGenerateNewCode() {
    ...
    try {
      ...
      const response = await fetch(
        `https://your-api-service-name.up.railway.app/users/me/referral-code`,
        {
          method: "PATCH",
          headers: {
